<template>
  <div>
  <div>
    <div style="width: 100%; background: #d2e9ff; border-radius: 0">
      <el-button @click="first">退出</el-button>
      <p style="
            font-family: Arial;
            font-size: 20px;
            font-weight: 800;
    ...
    <el-card style="margin-top:1%;border-radius: 0" shadow="never">
      <el-col>
        <el-row><Radar></Radar></el-row>
<el-row   style="width: 100%; background: dodgerblue;  margin-bottom: 15px;border-radius: 0">
          ...
          ">
           阶段,
            ...
            <el-row style="margin-left: 120px"><span style="
            font-family: Arial;
            font-size: 16px;
            font-weight: 500;
            display: inline-block;
        ...
        <el-row><el-card style="border-radius: 20px">
        <el-row>
          <el-col :span="6">
            <el-row style="margin-bottom: 15px"><span style="margin-left:20%">非常差</span></el-row>
            <el-row style="margin-bottom: 10px"><el-progress style="width: 100%" color=red :stroke-width="8"  :text-inside="true" :show-text="false" :percentage="100"></el-progress></el-row>
            <el-row><span>60</span><span style="margin-left:70%">70</span></el-row>
          </el-col>
          <el-col :span="6">
            <el-row style="margin-bottom: 15px"><span style="background-color:#046b2c;margin-left:15%;display: block;width:60px;border-radius: 8px"><span style="margin-left:25%;display: block;width:40px;color: white">较差</span></span></el-row>
            <el-row style="margin-bottom: 10px"><el-progress style="width: 100%" color=yellow :stroke-width="8"  :text-inside="true" :show-text="false" :percentage="100"></el-progress></el-row>
            <el-row><span style="margin-left:90%">80</span></el-row>
          </el-col>
          <el-col :span="6">
            <el-row style="margin-bottom: 15px"><span style="margin-left:30%">较好</span></el-row>
            <el-row style="margin-bottom: 10px"><el-progress style="width: 100%" :stroke-width="8"  :text-inside="true" :show-text="false" :percentage="100"></el-progress></el-row>
            <el-row><span style="margin-left:90%">90</span></el-row>
          </el-col>
          <el-col :span="6">
            <el-row style="margin-bottom: 15px"><span style="margin-left:20%">非常好</span></el-row>
            <el-row style="margin-bottom: 10px"><el-progress style="width: 100%"  :stroke-width="8"  :text-inside="true" :show-text="false" :percentage="100"></el-progress></el-row>
            <el-row><span style="margin-left:80%">100</span></el-row>
          </el-col>
        </el-row>
        </el-card></el-row>
        <el-row> <div style="margin-top: 20px" >
          <span style="font-weight:bold; color: #a4a4a4">信用更新历史</span>
          <el-progress  style="width: 100%"  :stroke-width="2"  color="#a1a3a6" :text-inside="true" :show-text="false" :percentage="100"></el-progress>
        </div></el-row>
        <el-row><el-card  :body-style="{ padding: '10px' }" style="margin-top: 20px;border-radius: 10px;background-color: #efefef" shadow="never">
            <el-row><span style="color:red">信用评分已下降！</span></el-row>
            <el-row><span>您已经完成了运单(YD202403200015),未按照规定轨迹行驶，</span></el-row>
              <el-row><span>信用评分-5分！</span></el-row>
        </el-card></el-row>
        <el-row> <el-card  :body-style="{ padding: '10px' }" style="margin-top: 20px;border-radius: 10px;background-color: #efefef" shadow="never">
          <el-row><span style="color:red">信用评分已下降！</span></el-row>
          <el-row><span>您已经完成了运单(YD202403200015),遭到投诉反馈,</span></el-row>
          <el-row><span>信用评分-5分！</span></el-row>
        </el-card></el-row>
        <el-row> <el-card  :body-style="{ padding: '10px' }" style="margin-top: 20px;border-radius: 10px;background-color: #efefef" shadow="never">
          <el-row><span style="color:red">信用评分已下降！</span></el-row>
          <el-row><span>您已经完成了运单(YD202403200015),货损率高达21%,</span></el-row>
          <el-row><span>信用评分-10分！</span></el-row>
        </el-card></el-row>
        <el-row> <el-card  :body-style="{ padding: '10px' }" style="margin-top: 20px;border-radius: 10px;background-color: #efefef" shadow="never">
          <el-row><span style="color:red">信用评分已下降！</span></el-row>
          <el-row><span>您已经完成了运单(YD202403200015),未能准时到达,</span></el-row>
          <el-row><span>信用评分-5分！</span></el-row>
        </el-card></el-row>
        <el-row> <el-card  :body-style="{ padding: '10px' }" style="margin-top: 20px;border-radius: 10px;background-color: #efefef" shadow="never">
          <el-row><span style="color:green">信用评分已提升！</span></el-row>
          <el-row><span>您已经上传了有效的驾驶证图片信息,</span></el-row>
          <el-row><span>信用评分+15分！</span></el-row>
        </el-card></el-row>
      </el-col>
    </el-card>
<!--      <el-row>-->
...
<!--                <el-row style="margin-top:50px"><span style="margin-top:10px;margin-left:10px;font-size:16px;background-color: red">路线差异大</span> <span style="margin-top:10px;margin-left:25px;font-size:16px;background-color: red">服务态度差</span></el-row>-->
