<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="司机驾龄" prop="driver experience">
        <el-input
          v-model="queryParams.driver experience"
          placeholder="请输入司机驾龄"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="informationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="司机驾龄" align="center" prop="driver experience" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="司机驾龄" prop="driver experience">
          <el-input v-model="form.driver experience" placeholder="请输入司机驾龄" />
        </el-form-item>
        <el-form-item label="司机信用" prop="driverCredit">
