  ...
  <div>
    <div class="size-icon">
      ...
      >
        ...
        <i
          class="el-icon-truck" style="margin-top:10px; color:orange;margin-left: 210px;margin-bottom:10px"
          slot="reference"
          @mouseover="changeStatus(item, true)"
          @mouseleave="changeStatus(item, false)"
        ></i></el-popover>
    </div>
    <el-steps :active="current" align-center finish-status="success" style="height:100px">
...
export default {
  ...
  data() {
    return {
      ...
      t: {},
      current: 2,
      item: {content: "车牌号: 晋H 56SF8", isShow: false}
    }
  },
  methods: {
