...
public class DriverInformation extends BaseEntity
{
    ...
    /** 司机驾龄 */
    @Excel(name = "司机驾龄")
    private String driver experience;
    ...
    public void setDriver experience(String driver experience) 
    {
        this.driver experience = driver experience;
    }

    public String getDriver experience() 
    {
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("driver experience", getDriver experience())
